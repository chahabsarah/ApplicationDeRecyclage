...
class AppServiceProvider extends ServiceProvider
{
    ...
    public function boot()
    {
        ...
        View::share([
            'transectionRateData' => $transectionRateData,
            'transectionRateBTCData' => $transectionRateBTCData,
            'transectionRateBTC' => $transectionRateBTC,
            'TopCreators' => $TopCreators,
            'TopCreatorsWeekly' => $TopCreatorsWeekly,
            'TopPlatform' => $TopPlatform,
            'User_info_for_header' => $User_info_for_header,
            'Statistics' => $Statistics,
            'RecentNotification' => $RecentNotification,
            'Balance' => $Balance,
            'Addmoney' => $Addmoney,
            'TopCreatorsMonthly' => $TopCreatorsMonthly,
            'transectionRate' => $transectionRate,
            'SidebarInf' => $SidebarInf,
