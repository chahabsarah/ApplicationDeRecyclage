                ...
                <div class="form-group">
                    ...
                    <div class="form-group__input">
                        <span class="nftmax-wc__icon">
                            <!-- SVG Icon for Email -->
                            <svg class="inline" xmlns="http://www.w3.org/2000/svg" width="22" height="20" fill="none">
                        ...
                        <input class="nftmax-wc__form-input" type="email" name="email" placeholder="demo232@gmail.com" value="{{ old('email') }}">
                    </div>
                </div>
                <div class="form-group">
                    ...
                    <div class="form-group__input">
                        <span class="nftmax-wc__icon">
                            ...
                            <svg class="inline" width="18" height="21" fill="none">
                        ...
                        <input class="nftmax-wc__form-input" id="password-field" type="password" name="password" placeholder="&#9679;&#9679;&#9679;&#9679;&#9679;&#9679;" maxlength="8">
                    </div>
                </div>
