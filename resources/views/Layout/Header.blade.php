		...
		<div class="body-bg" style="background-image:url('../../assets/img/body-bg.jpg')">
			...
			<div class="nftmax-smenu">
				...
				<div class="admin-menu">
					...
					<div class="logo">
						<a href="{{ url('/') }}">
							<img class="nftmax-logo__main" src="../../assets/img/recycler.png" alt="#" style="width:70px">
						</a>
						<div class="nftmax__sicon close-icon"><strong><b>ECOTUNIVERT</b></strong> <img src="../../assets/img/menu-toggle.svg" alt="#"> </div>
					</div>
					<!-- Author Details -->
...
<li>
    <a href="{{url('/centres')}}">
        <span class="menu-bar__text"><span class="nftmax-menu-icon nftmax-svg-icon__v9">
</span>
<span class="menu-bar__name">Centers list</span>
</span>
</a>
</li>

                            <li><a href="{{url('/collectes')}}"><span class="menu-bar__text"><span class="nftmax-menu-icon nftmax-svg-icon__v9">
                            </span><span class="menu-bar__name">Collectes</span></span></a></li>

                            <li><a href="{{url('/categories')}}"><span class="menu-bar__text"><span
												class="nftmax-menu-icon nftmax-svg-icon__v5">
											</span>
											<span class="menu-bar__name">Claims Categories</span></span></a>
												</li>
                                            ...
                                            <li><a href="{{url('/bonne_pratiques')}}"><span class="menu-bar__text"><span
													class="nftmax-menu-icon nftmax-svg-icon__v9">
												</span><span class="menu-bar__name">Bonnes Pratiques</span></span></a>
									</li>
							</ul>
						</div>
						<!-- End Nav Menu -->
					...
					<div class="admin-menu__two mg-top-50">
						...
						<div class="menu-bar">
                            ...
                            <span class="menu-bar__name">Frontoffice</span>
                        </span>
                    </a>
                </li>
                            </ul>
