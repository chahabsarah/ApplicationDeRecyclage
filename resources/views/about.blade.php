...
@section('content')
    ...
    <!-- Start Hero Section -->
    <x-hero subTitle='Modern & Beautiful TravelPro Theme' img='assets1/images/destination_header_bg.jpeg' title='about us' />
    <!-- End Hero Section -->
    ...
    <section class="cs_about cs_style_1">
      ...
      <div class="container">
        <div class="row align-items-center cs_gap_y_40 cs_mobile_reverse">
          ...
          <div class="col-lg-5 offset-lg-1"><img src="assets1/images/about_img.png" alt=""></div>
        </div>
      </div>
      <div class="cs_height_140 cs_height_lg_80"></div>
    </section>
    ...
    <!-- Start Banner Section -->
     <section class="cs_banner cs_style_2 cs_bg_filed cs_primary_bg" data-src="assets1/images/banner_bg_3.jpeg">
      <div class="cs_height_115 cs_height_lg_80"></div>
      <div class="container">
        <div class="row align-items-center cs_gap_y_40">
          <div class="col-lg-6">
            <div class="cs_banner_thumb">
              <img src="assets1/images/offer_text.png" alt="Offer Text">
            </div>
          </div>
          <div class="col-lg-6">
    ...
    <section>
      <div class="cs_height_140 cs_height_lg_80"></div>
      <div class="container">
        <div class="cs_video_block cs_style_1 cs_bg_filed position-relative" data-src="assets1/images/video_block.jpeg">
    ...
    <div>
      ...
      <div class="container">
        <div class="cs_brand_list cs_style_1">
          <div class="cs_brand"><img src="assets1/images/brand_1.svg" alt="Brand"></div>
          <div class="cs_brand"><img src="assets1/images/brand_2.svg" alt="Brand"></div>
          <div class="cs_brand"><img src="assets1/images/brand_3.svg" alt="Brand"></div>
          <div class="cs_brand"><img src="assets1/images/brand_4.svg" alt="Brand"></div>
          <div class="cs_brand"><img src="assets1/images/brand_5.svg" alt="Brand"></div>
        </div>
      </div>
