...
@section('content')
    ...
    <!-- Start Hero Section -->
    <x-hero subTitle='Modern & Beautiful Travel Theme' img='assets1/images/destination_header_bg.jpeg' title='Latest Blog' />
    <!-- End Hero Section -->
        ...
        <div class="col-lg-8">
          <article class="cs_post cs_style_5">
            <a href="{{ route('blogdetails') }}" class="cs_post_thumb cs_zoom">
              <img src="assets1/images/post_9.jpeg" alt="Post Thumb" class="w-100 h-100 cs_zoom_in">
            ...
            <h2 class="cs_post_title cs_fs_35 cs_semibold"><a href="{{ route('blogdetails') }}">EazyPNR is the only Theme you will ever need</a></h2>
          ...
          <article class="cs_post cs_style_5">
            <a href="{{ route('blogdetails') }}" class="cs_post_thumb cs_zoom">
              <img src="assets1/images/post_10.jpeg" alt="Post Thumb" class="w-100 h-100 cs_zoom_in">
              <span class="cs_link_hover"><i class="fas fa-link"></i></span>
            </a>
            <ul class="cs_post_meta cs_mp0 cs_primary_color">
              <li class="cs_accent_color">OCTOBER 01, 2024</li>
            ...
            <h2 class="cs_post_title cs_fs_35 cs_semibold"><a href="{{ route('blogdetails') }}">How To Get Strangers To Take Epic Travel</a></h2>
            <div class="cs_post_subtitle">Globally coordinate user friendly interfaces through 24/365 niche markets. Seamlessly supply accurate human capital with corporate e-markets. Efficiently architect enterprise-wide platforms after error-free process are Completely envisioneer market-driven e-markets through </div>
            <a href="{{ route('blogdetails') }}" class="cs_post_btn cs_fs_18 cs_medium cs_primary_color">
              <span>Continue Reading</span>
              <i class="fa-solid fa-arrow-right"></i>
          ...
          <article class="cs_post cs_style_5">
            <a href="{{ route('blogdetails') }}" class="cs_post_thumb cs_zoom">
              <img src="assets1/images/post_11.jpeg" alt="Post Thumb" class="w-100 h-100 cs_zoom_in">
              <span class="cs_link_hover"><i class="fas fa-link"></i></span>
            </a>
            <ul class="cs_post_meta cs_mp0 cs_primary_color">
              <li class="cs_accent_color">OCTOBER 01, 2024</li>
            ...
            <h2 class="cs_post_title cs_fs_35 cs_semibold"><a href="{{ route('blogdetails') }}">The Top 10 Destinations You Should Visit In</a></h2>
            <div class="cs_post_subtitle">Globally coordinate user friendly interfaces through 24/365 niche markets. Seamlessly supply accurate human capital with corporate e-markets. Efficiently architect enterprise-wide platforms after error-free process are  Completely envisioneer market-driven e-markets through </div>
            <a href="{{ route('blogdetails') }}" class="cs_post_btn cs_fs_18 cs_medium cs_primary_color">
              <span>Continue Reading</span>
              <i class="fa-solid fa-arrow-right"></i>
            ...
            <div class="cs_sidebar_item cs_gray_bg">
              ...
              <ul class="cs_recent_posts cs_mp0">
                <li>
                  <article class="cs_recent_post">
                    <a href="{{ route('blogdetails') }}" class="cs_recent_post_thumb cs_zoom">
                      <img src="assets1/images/latest_post_1.jpeg" alt="Post Thumb" class="cs_zoom_in w-100 h-100 object-fit-cover">
                    </a>
                    <div class="cs_recent_post_info">
                      <h3 class="cs_recent_post_title cs_fs_16 cs_medium cs_secondary_font">
                        <a href="{{ route('blogdetails') }}">How to Modify Your Car engine Properly?</a>
                      </h3>
                ...
                <li>
                  <article class="cs_recent_post">
                    <a href="{{ route('blogdetails') }}" class="cs_recent_post_thumb cs_zoom">
                      <img src="assets1/images/latest_post_2.jpeg" alt="Post Thumb" class="cs_zoom_in w-100 h-100 object-fit-cover">
                    </a>
                    <div class="cs_recent_post_info">
                      <h3 class="cs_recent_post_title cs_fs_16 cs_medium cs_secondary_font">
                        <a href="{{ route('blogdetails') }}">Top 10 New Car Available in our Showroom</a>
                      </h3>
                      <div class="cs_recent_post_date cs_fs_14">October 01, 2024</div>
                    </div>
                  </article>
                ...
                <li>
                  <article class="cs_recent_post">
                    <a href="{{ route('blogdetails') }}" class="cs_recent_post_thumb cs_zoom">
                      <img src="assets1/images/latest_post_3.jpeg" alt="Post Thumb" class="cs_zoom_in w-100 h-100 object-fit-cover">
                    </a>
                    <div class="cs_recent_post_info">
                      <h3 class="cs_recent_post_title cs_fs_16 cs_medium cs_secondary_font">
                ...
                <li>
                  <article class="cs_recent_post">
                    <a href="{{ route('blogdetails') }}" class="cs_recent_post_thumb cs_zoom">
                      <img src="assets1/images/latest_post_4.jpeg" alt="Post Thumb" class="cs_zoom_in w-100 h-100 object-fit-cover">
                    </a>
                    <div class="cs_recent_post_info">
                      <h3 class="cs_recent_post_title cs_fs_16 cs_medium cs_secondary_font">
                        <a href="{{ route('blogdetails') }}">Classification of Car Wash Type By Service</a>
                      </h3>
                      <div class="cs_recent_post_date cs_fs_14">October 01, 2024</div>
                    </div>
                  </article>
