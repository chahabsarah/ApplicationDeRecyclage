...
@section('content')
    <!-- Start Hero Section -->
    <x-hero subTitle='Modern & Beautiful TravelPro Theme' img='assets1/images/destination_header_bg.jpeg' title='Single Blog' />
    <!-- End Hero Section -->
        ...
        <div class="col-lg-8">
          <article class="cs_post_details">
            <div class="position-relative">
              <img src="assets1/images/post_details_1.jpeg" alt="Post Thumb">
            ...
            <div class="row">
              <div class="col-sm-5">
                <img src="assets1/images/post_details_2.jpeg" alt="Destination Image">
              </div>
              <div class="col-sm-7">
                <img src="assets1/images/post_details_3.jpeg" alt="Destination Image">
              </div>
            </div>
           ...
           <div class="cs_post_author">
            <div class="cs_author_top d-flex">
              <div class="cs_author_thumb">
                <img src="assets1/images/avatar_4.jpeg" alt="Avatar">
              </div>
              ...
              <li class="cs_comment">
                <div class="cs_comment_body">
                  <div class="cs_comment_author cs_fs_20 cs_medium cs_primary_color">
                    <img src="assets1/images/avatar_5.jpeg" alt="Avatar">
