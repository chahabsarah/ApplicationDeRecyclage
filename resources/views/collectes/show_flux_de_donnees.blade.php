                        ...
                        <div class="nftmax mg-top-40">
                            <div class="nftmax">
                                <div class="nftmax-_content">
                                    ...
                                    <h2>Explore the phases collect passes by!</h2>
                                                    ...
                                                    <div class="step-details">
                                                        ...
                                                        @if($phase->output_images)
                                                            ...
                                                            <p><strong >{{ $phase->output_description }}</strong> </p>
                                                                ...
                                                                <button class="nftmax__item-button--single nftmax-btn nftmax-btn__bordered bg radius" type="button" data-bs-target="#carouselPhase{{ $loop->iteration }}" data-bs-slide="prev">
                                                                ...
                                                                <button class="nftmax__item-button--single nftmax-btn nftmax-btn__bordered bg radius" style="float:right!important;" type="button" data-bs-target="#carouselPhase{{ $loop->iteration }}" data-bs-slide="next">
