...
@section('content')
    ...
    <!-- Start Hero Section -->
    <x-hero subTitle='Modern & Beautiful Travel Theme' img='assets1/images/destination_header_bg.jpeg' title='Popular Destination' />
    <!-- End Hero Section -->
        ...
        <div class="row cs_gap_y_50">
          <div class="col-lg-8">
            <div class="cs_post_details">
              <div class="row">
                <div class="col-lg-6">
                  <img src="assets1/images/destination_details_1.jpeg" alt="Destination Image">
                </div>
                <div class="col-lg-6">
                  <img src="assets1/images/destination_details_2.jpeg" alt="Destination Image">
                </div>
              </div>
              ...
              <div class="cs_list_wrapper cs_gray_bg">
                ...
                <ul class="cs_list cs_style_2 cs_fs_18 cs_primary_color">
                  <li>
                    <i><img src="assets1/images/icons/location.svg" alt="Icon"></i>
                    <span>Country: United Kingdom</span>
                  </li>
                  <li>
                    <i><img src="assets1/images/icons/visa.svg" alt="Icon"></i>
                    <span>Visa Requirements: No</span>
                  </li>
                  <li>
                    <i><img src="assets1/images/icons/language.svg" alt="Icon"></i>
                    <span>Languages spoken: English</span>
                  </li>
                  <li>
                    <i><img src="assets1/images/icons/rate.svg" alt="Icon"></i>
                    <span>Per Person: $2707</span>
                  </li>
                  <li>
                    <i><img src="assets1/images/icons/area.svg" alt="Icon"></i>
              ...
              <div class="row">
                <div class="col-lg-5">
                  <img src="assets1/images/destination_details_3.jpeg" alt="Destination Image">
                </div>
                <div class="col-lg-7">
                  <img src="assets1/images/destination_details_4.jpeg" alt="Destination Image">
                </div>
              </div>
                ...
                <li class="cs_comment">
                  <div class="cs_comment_body">
                    <div class="cs_comment_author cs_fs_20 cs_semibold cs_primary_color">
                      <img src="assets1/images/avatar_3.jpeg" alt="Avatar">
