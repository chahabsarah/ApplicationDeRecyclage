...
<section class="cs_hero cs_style_2 cs_accent_bg_1">
  <div class="cs_hero_in">
    <div class="cs_hero_img"><img src="assets1/images/hero_2.png" alt="Hero Thumb"></div>
      ...
      <div class="cs_button_group">
        ...
        <div class="cs_hero_ratings wow fadeInRight" data-wow-duration="0.8s" data-wow-delay="0.2s">
          <div class="cs_hero_rating_icon">
            <img src="assets1/images/icons/google_icon.svg" alt="Icom">
          </div>
...
<!-- Start CTA Section -->
<section class="cs_cta cs_style_1 cs_bg_filed cs_primary_bg cs_bg_fixed" data-src="assets1/images/banner_bg_2.jpeg">
        ...
        <div class="cs_partners_wrap overflow-hidden">
          <div class="cs_partners">
            <div class="cs_partner">
              <img src="assets1/images/brand_6.png" alt="Brand Logo">
            </div>
            <div class="cs_partner">
              <img src="assets1/images/brand_7.png" alt="Brand Logo">
            </div>
            <div class="cs_partner">
              <img src="assets1/images/brand_8.png" alt="Brand Logo">
            </div>
            <div class="cs_partner">
              <img src="assets1/images/brand_9.png" alt="Brand Logo">
            </div>
            <div class="cs_partner">
              <img src="assets1/images/brand_10.png" alt="Brand Logo">
            </div>
            <div class="cs_partner">
              <img src="assets1/images/brand_11.png" alt="Brand Logo">
            </div>
          </div>
        </div>
      </div>
    ...
    <div class="cs_iconbox_4_wrap">
      <div>
        <div class="row cs_gap_y_45">
          <div class="col-lg-12 col-6">
            <div class="cs_iconbox cs_style_4">
              <div class="cs_iconbox_icon cs_center">
                <img src="assets1/images/icons/calendar_icon_2.svg" alt="Calendar Icon">
              </div>
          ...
          <div class="col-lg-12 col-6">
            <div class="cs_iconbox cs_style_4">
              <div class="cs_iconbox_icon cs_center">
                <img src="assets1/images/icons/hotel-icon.svg" alt="Hotel Icon">
              </div>
      ...
      <div>
        <div class="cs_iconbox_4_thumb cs_center">
          <img src="assets1/images/about_4.png" alt="About Thumb">
        </div>
      </div>
      <div>
        <div class="row cs_gap_y_45">
          <div class="col-lg-12 col-6">
            <div class="cs_iconbox cs_style_4">
              <div class="cs_iconbox_icon cs_center">
                <img src="assets1/images/icons/compass_icon.svg" alt="Calendar Icon">
              </div>
          ...
          <div class="col-lg-12 col-6">
            <div class="cs_iconbox cs_style_4">
              <div class="cs_iconbox_icon cs_center">
                <img src="assets1/images/icons/headset_icon.svg" alt="Hotel Icon">
              </div>
  ...
  <div class="container">
    ...
    <div class="cs_card_4_list">
      <div class="cs_card cs_style_4 cs_hover_active active">
        <a href="{{ route('tourdetails') }}" class="cs_card_thumb cs_bg_filed" data-src="assets1/images/casestudy_1.jpeg"></a>
      ...
      <div class="cs_card cs_style_4 cs_hover_active">
        <a href="{{ route('tourdetails') }}" class="cs_card_thumb cs_bg_filed" data-src="assets1/images/casestudy_2.jpeg"></a>
        <a href="{{ route('tourdetails') }}" class="cs_card_icon cs_center position-absolute"><i class="fa-solid fa-chevron-right"></i></a>
        <div class="cs_card_in">
      ...
      <div class="cs_card cs_style_4 cs_hover_active">
        <a href="{{ route('tourdetails') }}" class="cs_card_thumb cs_bg_filed" data-src="assets1/images/casestudy_3.jpeg"></a>
        <a href="{{ route('tourdetails') }}" class="cs_card_icon cs_center position-absolute"><i class="fa-solid fa-chevron-right"></i></a>
        <div class="cs_card_in">
      ...
      <div class="cs_card cs_style_4 cs_hover_active">
        <a href="{{ route('tourdetails') }}" class="cs_card_thumb cs_bg_filed" data-src="assets1/images/casestudy_4.jpeg"></a>
        <a href="{{ route('tourdetails') }}" class="cs_card_icon cs_center position-absolute"><i class="fa-solid fa-chevron-right"></i></a>
        <div class="cs_card_in">
      ...
      <div class="cs_card cs_style_4 cs_hover_active">
        <a href="{{ route('tourdetails') }}" class="cs_card_thumb cs_bg_filed" data-src="assets1/images/casestudy_5.jpeg"></a>
        <a href="{{ route('tourdetails') }}" class="cs_card_icon cs_center position-absolute"><i class="fa-solid fa-chevron-right"></i></a>
        <div class="cs_card_in">
  ...
  <div class="container">
    ...
    <div class="row cs_gap_y_30">
      <div class="col-lg-4">
        <div class="cs_team cs_style_1 position-relative">
          <div class="cs_team_thumb cs_zoom overflow-hidden">
            <img src="assets1/images/team_1.jpeg" alt="Team Thumb" class="cs_zoom_in">
          </div>
      ...
      <div class="col-lg-4">
        <div class="cs_team cs_style_1 position-relative">
          <div class="cs_team_thumb cs_zoom overflow-hidden">
            <img src="assets1/images/team_2.jpeg" alt="Team Thumb" class="cs_zoom_in">
          </div>
          <div class="cs_team_info text-center position-absolute">
            <h2 class="cs_team_title cs_fs_24 cs_medium cs_white_color">David Cooper</h2>
           <p class="cs_team_subtitle cs_white_color">CO FOUNDER</p>
      ...
      <div class="col-lg-4">
        <div class="cs_team cs_style_1 position-relative">
          <div class="cs_team_thumb cs_zoom overflow-hidden">
            <img src="assets1/images/team_3.jpeg" alt="Team Thumb" class="cs_zoom_in">
          </div>
          <div class="cs_team_info text-center position-absolute">
            <h2 class="cs_team_title cs_fs_24 cs_medium cs_white_color">David Cooper</h2>
           <p class="cs_team_subtitle cs_white_color">CO FOUNDER</p>
...
<section class="cs_primary_bg cs_bg_filed cs_bg_fixed cs_parallax" data-src="assets1/images/accordian_bg.jpeg">
  <div class="cs_height_150 cs_height_lg_80"></div>
  <div class="container">
      ...
      <div class="col-xl-6 col-lg-5">
        <div class="cs_adventure_logo_wrap">
          <div class="cs_adventure_logo">
            <img src="assets1/images/adventure_logo.svg" alt="Logo" class="cs_to_rotate">
          </div>
        </div>
      </div>
  ...
  <div class="container cs_large">
        ...
        <div class="cs_slider_wrapper">
            ...
            <div class="cs_feedback cs_style_1 cs_radius_5 position-relative">
              <div class="cs_feedback_avatar">
                <div class="cs_avatar_thumb cs_radius_5 overflow-hidden">
                  <img src="assets1/images/testimonial_avatar_1.jpeg" alt="Avatar">
                </div>
          ...
          <div class="slick_slide_in">
            <div class="cs_feedback cs_style_1 cs_radius_5 position-relative">
              <div class="cs_feedback_avatar">
                <div class="cs_avatar_thumb cs_radius_5 overflow-hidden">
                  <img src="assets1/images/testimonial_avatar_2.jpeg" alt="Avatar">
                </div>
                <div class="cs_avatar_info">
                  <h3 class="cs_avatar_title cs_fs_24 cs_medium cs_secondary_font">Alexon Shen</h3>
                  <p class="cs_avatar_subtitle cs_accent_color mb-0">Founder & CEO</p>
          ...
          <div class="slick_slide_in">
            <div class="cs_feedback cs_style_1 cs_radius_5 position-relative">
              <div class="cs_feedback_avatar">
                <div class="cs_avatar_thumb cs_radius_5 overflow-hidden">
                  <img src="assets1/images/testimonial_avatar_2_1.jpeg" alt="Avatar">
                </div>
                <div class="cs_avatar_info">
                  <h3 class="cs_avatar_title cs_fs_24 cs_medium cs_secondary_font">Alexon Shen</h3>
                  <p class="cs_avatar_subtitle cs_accent_color mb-0">Founder & CEO</p>
    ...
    <div class="col-lg-6">
      <div class="cs_testimonial_thumb cs_radius_5 overflow-hidden position-relative">
        <img src="assets1/images/testimonial_right.jpeg" alt="Testimonial Thumb" class="w-100 h-100 object-fit-cover">
        <div class="cs_shape_1 position-absolute"></div>
        <div class="cs_shape_2 position-absolute">
          <img src="assets1/images/Quote.png" alt="Quote">
        </div>
      </div>
    </div>
  </div>
  ...
  <div class="container">
    ...
    <div class="row cs_gap_y_24">
      <div class="col-lg-4">
        <article class="cs_post cs_style_2 cs_white_bg">
          <a href="{{ route('blogdetails') }}" class="cs_post_thumb cs_zoom overflow-hidden position-relative">
            <img src="assets1/images/post_3.jpeg" alt="Post Thumb" class="cs_zoom_in">
      ...
      <div class="col-lg-4">
        <article class="cs_post cs_style_2 cs_white_bg">
          <a href="{{ route('blogdetails') }}" class="cs_post_thumb cs_zoom overflow-hidden position-relative">
            <img src="assets1/images/post_4.jpeg" alt="Post Thumb" class="cs_zoom_in">
            <div class="cs_posted_by cs_radius_2 cs_fs_16 cs_medium cs_white_color position-absolute">30 May</div>
            <div class="cs_post_overlay cs_radius_5 position-absolute"></div>
          </a>
          <div class="cs_post_info">
      ...
      <div class="col-lg-4">
        <article class="cs_post cs_style_2 cs_white_bg">
          <a href="{{ route('blogdetails') }}" class="cs_post_thumb cs_zoom overflow-hidden position-relative">
            <img src="assets1/images/post_5.jpeg" alt="Post Thumb" class="cs_zoom_in">
            <div class="cs_posted_by cs_radius_2 cs_fs_16 cs_medium cs_white_color position-absolute">30 May</div>
            <div class="cs_post_overlay cs_radius_5 position-absolute"></div>
          </a>
          <div class="cs_post_info">
