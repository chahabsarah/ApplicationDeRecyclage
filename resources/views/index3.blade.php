...
@section('content')
        ...
        <div class="cs_main_header_in">
          <div class="cs_main_header_left">
            <a class="cs_site_branding" href="{{ route('index') }}">
              <img src="assets1/images/logo_2.svg" alt="Logo">
            </a>
          </div>
    ...
    <!-- Start Hero Section -->
    <section class="cs_hero cs_style_3 cs_bg_filed" data-src="assets1/images/hero_bg_3.jpeg">
      <div class="cs_hero_in">
        <div class="cs_hero_img">
          <img src="assets1/images/hero_3.png" alt="Hero Thumb">
        </div>
        ...
        <div class="row align-items-center cs_gap_y_40">
          <div class="col-lg-6">
            <div class="cs_about_thumb position-relative">
              <img src="assets1/images/about_left_1.png" alt="About Thumb">
              <div class="cs_about_img_sm position-absolute">
                <img src="assets1/images/about_shape.png" alt="Rotating Logo">
              </div>
            </div>
          </div>
          <div class="col-lg-6">
    ...
    <!-- Start Video Section -->
    <section class="cs_video_block cs_style_1 cs_bg_filed cs_type_1 cs_primary_bg cs_bg_fixed" data-src="assets1/images/video_block_2.jpeg">
      ...
      <div class="container-fluid">
        <div class="row cs_gap_y_24">
          <div class="col-lg-3 col-sm-6">
            <div class="cs_card cs_style_1 cs_bg_filed cs_radius_5 position-relative" data-src="assets1/images/package_img_1.jpeg">
          ...
          <div class="col-lg-3 col-sm-6">
            <div class="cs_card cs_style_1 cs_bg_filed cs_radius_5 position-relative" data-src="assets1/images/package_img_2.jpeg">
              <div class="cs_card_overlay cs_radius_5 position-absolute w-100 h-100"></div>
              <div class="cs_card_content cs_accent_bg position-absolute">
                <div class="cs_card_meta cs_white_color">
                  <div>
          ...
          <div class="col-lg-3 col-sm-6">
            <div class="cs_card cs_style_1 cs_bg_filed cs_radius_5 position-relative" data-src="assets1/images/package_img_3.jpeg">
              <div class="cs_card_overlay cs_radius_5 position-absolute w-100 h-100"></div>
              <div class="cs_card_content cs_accent_bg position-absolute">
                <div class="cs_card_meta cs_white_color">
                  <div>
          ...
          <div class="col-lg-3 col-sm-6">
            <div class="cs_card cs_style_1 cs_bg_filed cs_radius_5 position-relative" data-src="assets1/images/package_img_4.jpeg">
              <div class="cs_card_overlay cs_radius_5 position-absolute w-100 h-100"></div>
              <div class="cs_card_content cs_accent_bg position-absolute">
                <div class="cs_card_meta cs_white_color">
                  <div>
      ...
      <div class="container">
        <div class="row cs_gap_y_24">
          ...
          <div class="col-lg-3 col-sm-6">
            <div class="cs_iconbox cs_style_2 text-center">
              <div class="cs_iconbox_icon cs_radius_15 cs_center">
                <img src="assets1/images/icons/home_icon.svg" alt="Featured Icon">
              </div>
          ...
          <div class="col-lg-3 col-sm-6">
            <div class="cs_iconbox cs_style_2 text-center">
              <div class="cs_iconbox_icon cs_radius_15 cs_center">
                <img src="assets1/images/icons/location_icon.svg" alt="Featured Icon">
              </div>
          ...
          <div class="col-lg-3 col-sm-6">
            <div class="cs_iconbox cs_style_2 text-center">
              <div class="cs_iconbox_icon cs_radius_15 cs_center">
                <img src="assets1/images/icons/pool_icon.svg" alt="Featured Icon">
              </div>
          ...
          <div class="col-lg-3 col-sm-6">
            <div class="cs_iconbox cs_style_2 text-center">
              <div class="cs_iconbox_icon cs_radius_15 cs_center">
                <img src="assets1/images/icons/wifi_icon.svg" alt="Featured Icon">
              </div>
          ...
          <div class="col-lg-3 col-sm-6">
            <div class="cs_iconbox cs_style_2 text-center">
              <div class="cs_iconbox_icon cs_radius_15 cs_center">
                <img src="assets1/images/icons/car_icon.svg" alt="Featured Icon">
              </div>
          ...
          <div class="col-lg-3 col-sm-6">
            <div class="cs_iconbox cs_style_2 text-center">
              <div class="cs_iconbox_icon cs_radius_15 cs_center">
                <img src="assets1/images/icons/fitness_icon.svg" alt="Featured Icon">
              </div>
    ...
    <section>
      ...
      <div class="container">
        ...
        <div class="cs_grid_3 cs_gallery_list cs_style_1">
          <a href="assets1/images/gallery_1.jpeg" class="cs_gallery_item cs_zoom">
            <img src="assets1/images/gallery_1.jpeg" alt="Gallery Image" class="cs_zoom_in">
            <div class="cs_gallery_overlay"></div>
            <div class="cs_gallery_icon position-absolute">
              <img src="assets1/images/icons/plus_icon.svg" alt="Icon">
            </div>
          </a>
          <a href="assets1/images/gallery_2.jpeg" class="cs_gallery_item cs_zoom">
            <img src="assets1/images/gallery_2.jpeg" alt="Gallery Image" class="cs_zoom_in">
            <div class="cs_gallery_overlay"></div>
            <div class="cs_gallery_icon position-absolute">
              <img src="assets1/images/icons/plus_icon.svg" alt="Icon">
            </div>
          </a>
          <a href="assets1/images/gallery_3.jpeg" class="cs_gallery_item cs_zoom">
            <img src="assets1/images/gallery_3.jpeg" alt="Gallery Image" class="cs_zoom_in">
            <div class="cs_gallery_overlay"></div>
            <div class="cs_gallery_icon position-absolute">
              <img src="assets1/images/icons/plus_icon.svg" alt="Icon">
            </div>
          </a>
          <a href="assets1/images/gallery_4.jpeg" class="cs_gallery_item cs_zoom">
            <img src="assets1/images/gallery_4.jpeg" alt="Gallery Image" class="cs_zoom_in">
            <div class="cs_gallery_overlay"></div>
            <div class="cs_gallery_icon position-absolute">
              <img src="assets1/images/icons/plus_icon.svg" alt="Icon">
            </div>
          </a>
          <a href="assets1/images/gallery_5.jpeg" class="cs_gallery_item cs_zoom">
            <img src="assets1/images/gallery_5.jpeg" alt="Gallery Image" class="cs_zoom_in">
            <div class="cs_gallery_overlay"></div>
            <div class="cs_gallery_icon position-absolute">
              <img src="assets1/images/icons/plus_icon.svg" alt="Icon">
            </div>
          </a>
          <a href="assets1/images/gallery_6.jpeg" class="cs_gallery_item cs_zoom">
            <img src="assets1/images/gallery_6.jpeg" alt="Gallery Image" class="cs_zoom_in">
            <div class="cs_gallery_overlay"></div>
            <div class="cs_gallery_icon position-absolute">
              <img src="assets1/images/icons/plus_icon.svg" alt="Icon">
            </div>
      ...
      <div class="container">
        <div class="row cs_gap_y_24">
          <div class="col-lg-4">
            <div class="cs_iconbox cs_style_3">
              <div class="cs_iconbox_icon cs_radius_15">
                <img src="assets1/images/icons/support_icon.svg" alt="Icon">
              </div>
              <div>
          ...
          <div class="col-lg-4">
            <div class="cs_iconbox cs_style_3">
              <div class="cs_iconbox_icon cs_radius_15">
                <img src="assets1/images/icons/security_icon.svg" alt="Icon">
              </div>
              <div>
          ...
          <div class="col-lg-4">
            <div class="cs_iconbox cs_style_3">
              <div class="cs_iconbox_icon cs_radius_15">
                <img src="assets1/images/icons/quality_icon.svg" alt="Icon">
              </div>
              <div>
      ...
      <div class="container">
        ...
        <div class="cs_grid_2">
          <div class="cs_grid_item">
            <a href="{{ route('destinationdetails') }}" class="cs_card cs_style_2 cs_zoom position-relative cs_radius_8">
              <div class="cs_card_thumb w-100 h-100">
                <img src="assets1/images/popular_destination_6.jpeg" alt="Card Image" class="w-100 h-100 cs_zoom_in">
              </div>
          ...
          <div class="cs_grid_item">
            <a href="{{ route('destinationdetails') }}" class="cs_card cs_style_2 cs_zoom position-relative cs_radius_8">
              <div class="cs_card_thumb w-100 h-100">
                <img src="assets1/images/popular_destination_7.jpeg" alt="Card Image" class="w-100 h-100 cs_zoom_in">
              </div>
              <div class="cs_card_content position-absolute">
          ...
          <div class="cs_grid_item">
            <a href="{{ route('destinationdetails') }}" class="cs_card cs_style_2 cs_zoom position-relative cs_radius_8">
              <div class="cs_card_thumb w-100 h-100">
                <img src="assets1/images/popular_destination_8.jpeg" alt="Card Image" class="w-100 h-100 cs_zoom_in">
              </div>
              <div class="cs_card_content position-absolute">
          ...
          <div class="cs_grid_item">
            <a href="{{ route('destinationdetails') }}" class="cs_card cs_style_2 cs_zoom position-relative cs_radius_8">
              <div class="cs_card_thumb w-100 h-100">
                <img src="assets1/images/popular_destination_9.jpeg" alt="Card Image" class="w-100 h-100 cs_zoom_in">
              </div>
              <div class="cs_card_content position-absolute">
          ...
          <div class="cs_grid_item">
            <a href="{{ route('destinationdetails') }}" class="cs_card cs_style_2 cs_zoom position-relative cs_radius_8">
              <div class="cs_card_thumb w-100 h-100">
                <img src="assets1/images/popular_destination_10.jpeg" alt="Card Image" class="w-100 h-100 cs_zoom_in">
              </div>
              <div class="cs_card_content position-absolute">
                ...
                <div class="cs_testimonial cs_style_2 cs_white_bg position-relative">
                  ...
                  <div class="cs_testimonial_avatar">
                    <div class="cs_avatar_thumb">
                      <img src="assets1/images/testimonial_avatar_3.jpeg" alt="Avatar">
                    </div>
                  ...
                  <div class="cs_quote_shape position-absolute">
                    <img src="assets1/images/quote_shape.svg" alt="Quote Shape">
                  </div>
                </div>
              </div>
              <div class="slick_slide_in">
                <div class="cs_testimonial cs_style_2 cs_white_bg position-relative">
                  ...
                  <div class="cs_testimonial_avatar">
                    <div class="cs_avatar_thumb">
                      <img src="assets1/images/testimonial_avatar_4.jpeg" alt="Avatar">
                    </div>
                    <div class="cs_avatar_info">
                      <h3 class="cs_avatar_title cs_fs_24 cs_medium">Cameron Williamson</h3>
                      <p class="cs_avatar_subtitle cs_accent_color mb-0">Ceo & Founder</p>
      ...
      <div class="container">
        ...
        <div class="cs_grid_4">
          <div class="cs_grid_item">
            <article class="cs_post cs_style_3">
              <a href="{{ route('blogdetails') }}" class="cs_post_thumb cs_zoom">
                <img src="assets1/images/post_6.jpeg" alt="Post Thumb" class="cs_zoom_in">
                <span class="cs_link_hover"><i class="fas fa-link"></i></span>
              </a>
              <div class="cs_post_info">
                <div class="cs_post_meta">
                  <img src="assets1/images/icons/calendar_icon.svg" alt="Icon"> <span>September 26, 2024</span>
                </div>
          ...
          <div class="cs_grid_item">
            <article class="cs_post cs_style_3">
              <a href="{{ route('blogdetails') }}" class="cs_post_thumb cs_zoom">
                <img src="assets1/images/post_8.jpeg" alt="Post Thumb" class="cs_zoom_in">
                <span class="cs_link_hover"><i class="fas fa-link"></i></span>
              </a>
              <div class="cs_post_info">
                <div class="cs_post_meta">
          ...
          <div class="cs_grid_item">
            <article class="cs_post cs_style_3">
              <a href="{{ route('blogdetails') }}" class="cs_post_thumb cs_zoom">
                <img src="assets1/images/post_7.jpeg" alt="Post Thumb" class="cs_zoom_in">
                <span class="cs_link_hover"><i class="fas fa-link"></i></span>
              </a>
              <div class="cs_post_info">
                <div class="cs_post_meta">
