...
@section('content')
    ...
    <!-- Start Hero Section -->
    <x-hero subTitle='Modern & Beautiful Travel Theme' img='assets1/images/tour_header_bg.jpeg' title='Tour Details' />
    <!-- End Hero Section -->
      ...
      <div class="row cs_gap_y_50">
        <div class="col-lg-8">
          <div class="cs_post_details">
            ...
            <img src="assets1/images/tour_details.jpeg" alt="Tour Thumb">
          ...
          <div class="cs_tour_gallery">
            ...
            <div class="cs_gallery_img cs_radius_5">
              <img src="assets1/images/gallery_7.jpeg" alt="Gallery Image">
            </div>
            <div class="cs_gallery_img cs_radius_5">
              <img src="assets1/images/gallery_8.jpeg" alt="Gallery Image">
            </div>
            <div class="cs_gallery_img cs_radius_5">
              <img src="assets1/images/gallery_9.jpeg" alt="Gallery Image">
            </div>
          </div>
          </div>
        </div>
            ...
            <div class="cs_post_widget">
              ...
              <ul class="cs_recent_posts cs_mp0">
                <li>
                  <article class="cs_recent_post">
                    <a href="{{ route('blogdetails') }}" class="cs_recent_post_thumb cs_zoom">
                      <img src="assets1/images/latest_post_5.jpeg" alt="Post Thumb" class="cs_zoom_in w-100 h-100 object-fit-cover">
                    </a>
                ...
                <li>
                  <article class="cs_recent_post">
                    <a href="{{ route('blogdetails') }}" class="cs_recent_post_thumb cs_zoom">
                      <img src="assets1/images/latest_post_6.jpeg" alt="Post Thumb" class="cs_zoom_in w-100 h-100 object-fit-cover">
                    </a>
                    <div class="cs_recent_post_info">
                      <h3 class="cs_recent_post_title cs_fs_18 cs_medium">
                ...
                <li>
                  <article class="cs_recent_post">
                    <a href="{{ route('blogdetails') }}" class="cs_recent_post_thumb cs_zoom">
                      <img src="assets1/images/latest_post_7.jpeg" alt="Post Thumb" class="cs_zoom_in w-100 h-100 object-fit-cover">
                    </a>
                    <div class="cs_recent_post_info">
                      <h3 class="cs_recent_post_title cs_fs_18 cs_medium">
